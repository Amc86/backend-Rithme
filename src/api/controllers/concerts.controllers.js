...
const getAllConcerts = async (request, response) => {
    try {
        ...
        const getAllConcerts = await Concert.find().populate('artists halls'); //Cogemos todas las series de nuestro modelo "Enterprise".
...
const postNewConcert = async (request, response) => {
    try {
        ...
        const newConcert = new Concert({artists, date, hour, price, halls});
